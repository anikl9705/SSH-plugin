...
package com.sample.app.ssh.vim25.services;
...
import com.sample.app.ssh.gateway.SessionService;
...
public class VimObjectService {
   ...
   /**
    * Retrives information about the vSphere Host Objects from a vCenter Server
   ...
   /**
    * For a given ServerInfo(which specifies the vCenter Server), vSphere Object
    * and properties, retrieves the values of properties for the given
    * vSphere Object in the vCenter Server defined in the ServerInfo
    * <p>
   ...
   public List<Map<String, Object>> retrieveObjectProperties(
      ...
      final VimPortType vimPort = this.sessionService.getVimPort(vcenterGuid);
    ...
    * retrieves the ServiceContent using the vimPort
    *
    ...
    * created vimPort and creates a service instance ManagedObjectReference
    *
